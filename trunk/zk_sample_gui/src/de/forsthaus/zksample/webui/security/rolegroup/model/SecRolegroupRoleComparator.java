...
public class SecRolegroupRoleComparator implements Comparator<SecRole>, Serializable {
	...
	public SecRolegroupRoleComparator(boolean ascd, FieldsEnum columnIndex) {
		this.ascending = ascd;
