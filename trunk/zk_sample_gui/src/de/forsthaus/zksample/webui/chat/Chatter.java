 ...
 * @author robbiecheng
 */
public class Chatter extends Thread implements Serializable {

	private static final long serialVersionUID = 1L;
	private transient final static Log log = Log.lookup(Chatter.class);

	private transient boolean _ceased;

	private transient ChatRoom _chatroom;

	private transient final Desktop _desktop;

	private transient Component _msgBoard;

	private transient String _name;

	private transient List<String> _msgs;
